...
const Grid = ({ data, columns, outerRef, innerRef, columnWidths, hasStickyRightColumn, displayHeight, headerRowHeight, rowHeight, rowKey, fullWidth, selection, activeCell, activeHeaderCell, rowClassName, cellClassName, children, editing, getContextMenuItems, setRowData, deleteRows, duplicateRows, insertRowAfter, stopEditing, onScroll, }) => {
    var _a, _b, _c, _d;
    ...
    return (react_1.default.createElement("div", { ref: outerRef, className: "dsg-container", onScroll: onScroll, style: { height: displayHeight } },
        react_1.default.createElement("div", { ref: innerRef, style: {
            ...
            headerRowHeight > 0 && (react_1.default.createElement("div", { className: (0, classnames_1.default)('dsg-row', 'dsg-row-header'), style: {
                    ...
                    (activeHeaderCell === null || activeHeaderCell === void 0 ? void 0 : activeHeaderCell.col) === col.index - 1) &&
